...
<div class="munka2" style="box-shadow: 6px 12px 12px 5px green;"><p style="border-bottom: 3px dotted rgb(204, 204, 204); border-top: 3px dotted rgb(204, 204, 204); padding: 0px; font-weight: bold; font-size: 140%; color: rgb(0, 51, 102);"><a href="fizikai.php">KÖNNYŰ FIZIKAI</a></p></div>
...
<table style="margin: auto; text-align: left; width: 1000px; background-image: url(orange.png);" border="0" cellpadding="0" cellspacing="0">
  ...
  <tbody>
    ...
    <tr>
      ...
      <?php
$file = fopen("Munkák/fizikaimunkak.csv", "r");
$tomb =[];
...
<form method="POST" action="fizikai.php">
