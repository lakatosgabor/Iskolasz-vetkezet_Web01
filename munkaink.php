...
<td style="padding-right: 20px;"><div class="munka2" style="box-shadow: 6px 12px 12px 5px green;"><p style="border-bottom: 3px dotted rgb(204, 204, 204); border-top: 3px dotted rgb(204, 204, 204); padding: 0px; font-weight: bold; font-size: 140%; color: rgb(0, 51, 102);"><a href="munkaink.php">LEGFRISSEBB</a></p></div>
...
<form method="POST" action="munkaink.php">
