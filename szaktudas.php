...
<div class="munka2" style="box-shadow: 6px 12px 12px 5px green;"><p style="border-bottom: 3px dotted rgb(204, 204, 204); border-top: 3px dotted rgb(204, 204, 204); padding: 0px; font-weight: bold; font-size: 140%; color: rgb(0, 51, 102);"><a href="szaktudas.php">SZAKTUDÁS IGÉNYLŐ</a></p></div>
...
<div class="munka2"><p style="border-bottom: 3px dotted rgb(204, 204, 204); border-top: 3px dotted rgb(204, 204, 204); padding: 0px; font-weight: bold; font-size: 140%; color: rgb(0, 51, 102);"><a href="etterem.php">ÉTTERMI MUNKÁK</a></p></div>
</td>
...
<table style="margin: auto; text-align: left; width: 1000px; background-image: url(orange.png);" border="0" cellpadding="0" cellspacing="0">
  ...
  <tbody>
    ...
    <tr>
      ...
      <?php
$file = fopen("Munkák/szaktudastigenylomunkak.csv", "r");
$tomb =[];
...
<form method="POST" action="szaktudas.php">
